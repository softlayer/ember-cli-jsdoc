...
This is the issue tracker for `ember-cli-jsdoc`. The community uses this site to collect and track bugs and discussions
of new features. If you are having difficulties using `ember-cli-jsdoc` or have a question about usage please ask a
question on Stack Overflow: http://stackoverflow.com/questions/ask?tags=ember-cli-jsdoc
...
4. Your issue will be verified. The provided demo will be tested for correctness. The ember-cli-jsdoc team will work
with you until your issue can be verified.

5. Keep up to date with feedback from the ember-cli-jsdoc team on your ticket. Your ticket may be closed if it becomes
stale.
...
Contributions to the ember-cli-jsdoc project require the submission of a contributer license agreement. Individual
